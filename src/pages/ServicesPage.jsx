  ...
  const detailedServices = [
    {
      ...
      fullDesc: 'Our residential team transforms private gardens, courtyards, and luxury Johannesburg estates into sustainable living sanctuaries. Led by Eric and CEO Cullen Hettema, we combine architectural precision with native South African flora.',
      features: [
    ...
    },
    {
      ...
      shortDesc: 'Weekly or monthly estate care, turf management, and seasonal pruning for Johannesburg properties by certified horticulturists.',
    ...
    },
    {
      ...
      shortDesc: 'Automated drip irrigation and greywater recycling systems for Johannesburg properties, designed for maximum water conservation.',
      fullDesc: 'Water conservation is at the heart of Grow Green. We install smart, weather-aware irrigation systems for our Johannesburg clients that monitor rain patterns and optimize watering schedules.',
      features: [
      ...
      <section style={{ background: '#0D4733', color: '#FFFFFF', padding: '60px 0 40px 0', textAlign: 'center' }}>
        <div className="container" style={{ maxWidth: '800px' }}>
          ...
          <p style={{ color: 'rgba(255,255,255,0.85)', fontSize: '1.05rem', lineHeight: 1.6 }}>
            From initial 3D landscape architecture to ongoing estate care and bulk indigenous nursery supply in Johannesburg.
          </p>
        </div>
      </section>
