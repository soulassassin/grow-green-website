...
export default function ServicesPage({ openQuoteModal }) {
  const detailedServices = [
    ...
    },
    {
      ...
      shortDesc: 'Bulk and retail supply of climate-matched indigenous South African plants, King Proteas, Spekboom, succulents, and fruit trees.',
      ...
      features: [
        ...
        'Nationwide SA delivery with growth guarantees'
      ],
